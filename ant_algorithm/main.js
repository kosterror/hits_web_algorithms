...
export const WIDTH = 1000;  //ширина канваса
export const HEIGHT = 600;  //высота канваса
export const VERTEX_RADIUS = 20;    //радиус вершин, которые мы будем рисовать на канвасе

canvas.width = WIDTH;
canvas.height = HEIGHT;

export let activeMode = { value: 0 };   //сделал в виде объекта, так как хочется обращаться по ссылке
export let verticesList = [];           //список вершин
